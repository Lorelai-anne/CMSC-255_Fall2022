...
public class HouseTest {
    ...
    public void House_parameterizedConstructorTest() {
        House testHouse = new House("Claire Sparks",85,750.50,Bedrooms.TWO_BEDROOM,Baths.ONE,Color.GRAY);

        testVariable("owner",testHouse,"Claire Sparks","When checking the value of owner we");
